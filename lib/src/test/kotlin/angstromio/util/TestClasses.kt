...
data class StaticSecondaryConstructorWithMethodAnnotation(
    ...
    @Widget("widget1") fun widget1(): String = "this is widget 1 method"
}

interface AncestorWithAnnotations {
    @get:Annotation1 val one: String
    @get:Annotation2 val two: String
}
...
data class ClassThreeFourAncestorOneTwo(
    ...
    @Annotation3 val three: String,
    @Annotation4 val four: String) : AncestorWithAnnotations
